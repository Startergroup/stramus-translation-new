<template>
  <transition-fade :duration="350">
    <div class="tw-column-start tw-w-full lg:tw-w-[320px] tw-px-4 tw-py-6 tw-gap-10 tw-rounded-md tw-bg-sky/white dark:tw-bg-ink/darker tw-max-h-full tw-overflow-y-auto tw-relative">
